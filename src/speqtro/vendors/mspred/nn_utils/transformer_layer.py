"""transformer_layer.py -- vendored from ms-pred, imports fixed for speqtro.
...
class TransformerEncoderLayer(Module):
    r"""TransformerEncoderLayer with optional pairwise attention."""
...
class MultiheadAttention(Module):
    r"""Multi-Head Attention with optional additive/pairwise modes."""
    ...
    def _additive_attn(self, q, k, v, attn_mask=None, dropout_p=0.0, pairwise_features=None):
        B, Nt, E = q.shape
    ...
    def _scaled_dot_product_attention(self, q, k, v, attn_mask=None, dropout_p=0.0, pairwise_features=None):
        B, Nt, E = q.shape
        q = q / math.sqrt(E)
