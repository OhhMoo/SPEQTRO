"""run_magma.py -- vendored from ms-pred, imports fixed for speqtro.

Entry point into running magma program (inference-only subset).
"""
import logging
    ...
    for colli_eng, spectrum in spectra.items():
        ...
        for frag in pruned_nodes:
            ...
            for i in peak_intens:
                # Do not renormalize!
                inten_vec[i["frag_h_shift"]] = i["inten"]
